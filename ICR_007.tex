...
\item How does this factor affect the reponse? Does it interact with other factors?
\item Which design variation is better?
\end{itemize}
 Regression is a tool that would allow DCA's engineers to answer questions like these. Knowing which design parameters are important for a robust product, and how these parameters interact, .  Being able to use regression models opens up more nuanced questions such as: ``Do $x_1$ and $x_2$ interact? If so, by how much?''.
