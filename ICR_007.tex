...
Visualization serves to expose patterns in data in a way that's immediately interpretable. It allows the gist of lots of information to be seen without, or with as little, explanation as possible. 
