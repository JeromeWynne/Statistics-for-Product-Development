...
\section{Experiment Design}
Experiment design is motivated by trying to find efficient ways to explain response variation. Attributing response variation to product factors is the first step towards tuning those factors to produce a desirable response. Experimental investigations should determine what the effects of factors are on the response, using the resources available. Response surface methodologies would allow DCA's engineers to do this.
